...
class LoraConfig(PeftConfig):
    ...
    init_lora_weights: (
        bool | Literal["gaussian", "eva", "olora", "pissa", "pissa_niter_[number of iters]", "loftq","cloq"]
    ) = field(
        default=True,
        metadata={
            "help": (
    ...
    loftq_config: Union[CloQConfig, dict] = field(
        ...
        metadata={
            "help": (
                "The configuration of CloQ. If this is passed, then LoftQ will be used to quantize the backbone "
                "weights and initialize Lora layers. Also set `init_lora_weights='loftq'` in this case."
            )
        },
    )
